// This file contains the store contact information for different locations
...
const LocationList = [
    {
        ...
        store: [
            {
                store_name: "(Y)OUR CAR - Churchill",
